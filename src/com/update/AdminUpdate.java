		...
		confirmPass=request.getParameter("Cpass");
			...
			if(pass.equals(confirmPass)) 
			{
				try 
				{
					...
					System.out.println("Connection Established admin update");
					ps=con.prepareStatement("update adminlogin set phno='"+phoneNumber+"', address=' "+address+"' , password='"+pass+"' where  email='"+email+"'");
					ps.executeUpdate();
