...
/**
 * Servlet implementation class NotesUpdate
 */
@WebServlet("/NotesUpdate")
public class NotesUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ps=con.prepareStatement("insert into uploadnotes(notes, email, link) values ('"+notes+"','"+email+"','"+link+"')");
			ps.executeUpdate();
