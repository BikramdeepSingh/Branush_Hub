...
<html lang="en">
  <head>
    ...
    <link href="CSS/AllLogin.css" rel="stylesheet" type="text/css" />
      ...
      <div class="login-container">
        ...
        <div class="form-login">
          <form action='Login' method='post'>
            ...
            />
            <button class="submit" type="submit" name='button' value='StudentLogin'>Log In</button>
          </form>
        </div>
      </div>
    </div>
